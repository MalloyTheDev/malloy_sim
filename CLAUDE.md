...
```text
M1-M36 complete: math, time, sim_core, N-body, terminal demo, diagnostics,
...
box-against-sphere collision, Coulomb friction for particle contacts, and
box-against-box collision in two dimensions.
```
...
separating-axis test, the first non-disc 2D collision) are all done. See
`docs/07_POST_M5_ROADMAP.md`.

Do not start any further milestone (M37 or later) unless explicitly asked, and
